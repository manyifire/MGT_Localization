...
SENTENCE_HEAD_FOLDER=logs/mixed_code
SAVE_FOLDER=results

#SENTENCE_HEAD_FOLDER=logs/adaloc_visualnews
#SAVE_FOLDER=results/adaloc/goodnews_log-visualnews
...
#     --data_path=${DATA_FOLDER}/goodnews_test-${LLM_name}-art1000-seg1.json\
...
#   python AdaLoc/inference.py\
#     --data_path=${DATA_FOLDER}/goodnews_test-${LLM_name}-art1000-seg2.json\
#     --sentence_head_folder=${SENTENCE_HEAD_FOLDER}\
#     --article_num=1000\
#     --save_folder=${SAVE_FOLDER}\
...
#   python AdaLoc/inference.py\
#     --data_path=${DATA_FOLDER}/goodnews_test-${LLM_name}-art1000-seg3.json\
#     --sentence_head_folder=${SENTENCE_HEAD_FOLDER}\
#     --article_num=1000\
#     --save_folder=${SAVE_FOLDER}\
